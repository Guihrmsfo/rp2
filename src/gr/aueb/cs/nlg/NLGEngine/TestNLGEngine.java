...
public class TestNLGEngine
{
    ...
    public static void main(String args[])
    {
        try
        {
            // change the paths of the .owl and .rdf files
            // compile and run the file
            
            String owlPath = "C:\\NaturalOWL\\NLFiles-MPIRO\\mpiro.owl";
            String NLResourcePath = "C:\\NaturalOWL\\NLFiles-MPIRO\\";
            
            boolean useEmulator = true;   
            
            boolean Load_PServer_Databases = false;        
            
            String Communication_Server_IP = "";
            int Communication_Server_port = -1;
            ...
            NLGEngine myEngine =  new NLGEngine(owlPath,
                                                ...
                                                Communication_Server_IP,     // navigation server IP
                                                Communication_Server_port,     // navigation server port (-1 means to use the default port 53000)  
