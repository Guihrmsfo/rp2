...
public class UserModellingQueryManager2
{     
    public String NLGUserModellingNS = "http://www.aueb.gr/users/ion/owlnl/UserModelling#";
    static Logger logger = Logger.getLogger(UserModellingQueryManager2.class);
    //appropriateness
    ...
    public UserModellingQueryManager2 (OntModel model)
    {        
        this.model = model;	
    }
   ...
   // check if the specified user type exists
    ...
    {
        logger.debug("===Test user modelling===");
        UserModellingQueryManager2 UMQM = new UserModellingQueryManager2(null); 
        UMQM.LoadUserModellingInfo("C:\\NLG_Project\\NLFiles-MPIRO\\", "UserModelling.rdf");
        UMQM.writeUM(null, "C:\\NLG_Project\\NLFiles-MPIRO\\moufaUserModelling.rdf");
                
        /*
        UserModellingQueryManager2 UMQM = new UserModellingQueryManager2(); 
...
}//class UserModellingQueryManager2